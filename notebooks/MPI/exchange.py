...
grid.Sendrecv(sendbuf_hor, recvbuf=recvbuf_hor, dest=nbr_left, source=nbr_right)
grid.Sendrecv(sendbuf_ver, recvbuf=recvbuf_ver, dest=nbr_up, source=nbr_down)
...
grid.Sendrecv(sendbuf_hor, recvbuf=recvbuf_hor, dest=nbr_right, source=nbr_left)
grid.Sendrecv(sendbuf_ver, recvbuf=recvbuf_ver, dest=nbr_down, source=nbr_up)
